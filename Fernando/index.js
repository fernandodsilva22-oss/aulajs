...
// // encontrar o maior número dentro de um arrrey
...
//string
//contar caracteres
// const nome = 'Fernando Domingues';
// console.log(nome.length);
// console.log(nome[11]);
// console.log(nome.indexOf('Domingues'))
// console.log(nome.slice(3, 18))
